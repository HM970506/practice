...
{ printf("[Stack: Full] 스택이 꽉 차서 원소 \'%c\' 는 삽입이 불가능합니다.\n", anElementForPush);
}
...
void AppView_out_BottomOrTopStack()
{
    printf("[Stack]");
}
...
void AppView_out_poppedElementByPop1(char poppedChar)
{
...
void AppView_out_pops(char poppedChar)
{
    printf("-Pops: 삭제된 원소는 '%c' 입니다. \n", poppedChar);
}