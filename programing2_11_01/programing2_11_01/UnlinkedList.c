...
int  UnsortedLinkedList_isEmpty(UnsortedLinkedList* _this)
{ 
...
{
    if (UnsortedLinkedList_isFull(_this)) return  FALSE;
    else {
...
{
    if (UnsortedLinkedList_isEmpty(_this)) return  ELEMENT_DOES_NOT_EXIST;
    else 
    {
